...
class MenApparel(ABC):
    pass

class Coat(MenApparel):
    def __init__(self, height):
        self.height = height

    def coat_material_volume(self):
        return self.height / 6.5 + 0.5

class Costume(MenApparel):
    def __init__(self, size):
        self.size = size

    def cos_material_volume(self):
        return self.size * 2 + 0.3

cost_45 = Costume(10)
print(cost_45.cos_material_volume())

coat_12 = Coat(178)
print(coat_12.coat_material_volume())